      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex items-center w-full p-6">
          ...
          <button
            ...
            className="p-2 hover:bg-white/50 rounded-lg transition-colors z-10 mr-auto"
            aria-label={
