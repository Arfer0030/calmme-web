...
export default function AssessmentResultContent() {
  ...
  useEffect(() => {
    ...
    if (scoreValue <= 4) setResult("Minimal Anxiety");
    else if (scoreValue <= 9) setResult("Mild Anxiety");
    else if (scoreValue <= 14) setResult("Moderate Anxiety");
    else setResult("Severe Anxiety");
  }, [searchParams]);

  const handleBack = () => router.push("/home");
  const handleDownload = () => router.push("/home");
  const handleMeditate = () => router.push("/meditate");
  const handleConsultation = () => router.push("/consultation");
  ...
  return (
    <DashboardLayout
      ...
      backgroundColor="bg-gradient-to-b from-purple-100 to-white"
    >
      {/* Progress Bar */}
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-4">
              Take a moment to relax and clear your mind with guided meditation
              tailored to your current mental state.
            </p>
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-4">
              Get professional support and guidance from qualified psychologists
            ...
            <div className="text-xs text-gray-500 flex flex-col gap-1">
              ...
              <span>
                📅 Private consultations available via chat, call, or video call
              </span>
